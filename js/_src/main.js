			...
			$('.main').each(function() {
				...
				// Hack: IE8 fallback.
					if (skel.vars.IEVersion < 9) {
						...
						$this
							.css('background-image', 'url("' + $primaryImg.attr('data-echo') + '")')
							.css('-ms-behavior', 'url("/js/ie/backgroundsize.min.htc")');
				...
				// Create bg and append it to body.
					$bg = $('<div class="main-bg" id="' + $this.attr('id') + '-bg"></div>')
						.css('background-image', (
							'url("/images/overlay.png"), url("' + $primaryImg.attr('data-echo') + '")'
						))
						.appendTo($body);
